            ...
            <div class="md:flex w-full">
                <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                    <div class="text-center mb-10">
                        <h1 class="font-bold text-3xl text-blue-900">LOG IN</h1>
                    ...
                    <div>
                        <form action="{{'/login'}}" method="POST">
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    ...
                                    <div class="flex">
                                        ...
                                        <input type="email" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="" name="email" id="email" >
                                    </div>
                                </div>
                            </div>
                            <div class="flex -mx-3">
                            ...
                            <div class="flex -mx-3">
                                <div class="w-full px-3 mb-5">
                                    <button class="block w-full max-w-xs mx-auto bg-blue-500 hover:bg-blue-700 focus:bg-blue-700 text-white rounded-lg px-3 py-3 font-semibold" type="submit">LOG IN</button>
                                </div>
                            </div>
                ...
                <div class="w-full md:w-1/2 flex justify-center items-center bg-blue-500">
