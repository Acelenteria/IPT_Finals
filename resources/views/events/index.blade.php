...
<div class="container mx-auto p-6">
    ...
    @endif
    <h1 class="text-4xl text-center text-blue-500 font-dark font-extrabold mb-8">Event List</h1>
            @role('admin')
            <div>
        ...
        <div>
            <table class="text-left bg-white">
                <thead class="bg-blue-100 sticky top-0">
                    <tr>
                        <th class="px-6 py-3 text-blue-600 font-bold uppercase tracking-wider">Name</th>
                        <th class="px-6 py-3 text-blue-600 font-bold uppercase tracking-wider">Date</th>
                        <th class="px-6 py-3 text-blue-600 font-bold uppercase tracking-wider">Location</th>
                        <th class="px-6 py-3 text-blue-600 font-bold uppercase tracking-wider">Guest</th>
                        <th class="px-6 py-3 text-blue-600 font-bold uppercase tracking-wider">Type</th>
                        <th class="px-6 py-3 text-blue-600 font-bold uppercase tracking-wider">Description</th>
                        <th class="px-6 py-3 text-blue-600 font-bold uppercase tracking-wider">Action</th>
                    </tr>
                </thead>
